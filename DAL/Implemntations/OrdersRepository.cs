...
namespace DAL.Implemntations
{
    public class OrdersRepository : IOrdersRepository
    {
        ...
        {
            var order = new Order { CreatedAt = DateTime.Now, StatusId = model.StatusId, UserId = model.UserId, TotalPrice = model.TotalPrice, DeliveryInfo = model.DeliveryInfo, DeliveryLatitude = model.DeliveryLatitude, DeliveryLongitude = model.DeliveryLongitude };
